 ...
 <link rel="icon" type="image/png" href="./assets/Images/Prime_code_logo.png">
         ...
         <div class="container">
             ...
             <div class="collapse navbar-collapse" id="mainNavbar">
                 <ul class="navbar-nav mx-auto">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" href="portfolio.php">Success Stories</a>
                     </li>

                     <li class="nav-item">
                         <a class="nav-link" href="careers.php">Blogs</a>
                     </li>
